...
```mermaid
graph TD
    Noah["Noah Carter ⚰️<br/>(Deceased — Victim)"]
    Ethan["Ethan Carter ✅<br/>Junior Special Agent"]
    ...
    Brooks -- "secretly reports on" --> Robert
    Robert -- "leads" --> Marketplace
    Marketplace -- "responsible for death of" --> Noah
    Olivia -. "anonymously guides<br/>(Ethan unaware of true identity)" .-> Ethan
